    ...
    return GlassMorphism(
      ...
      column: Column(
        children: [
          ...
          (userDetails['owner_id'] != null && userDetails['vehicle_type_name'] == null)
              ? Row(
                  children: [
                    MyText(
                      text: languages[choosenLanguage]['text_no_fleet_assigned'],
                      ...
                      child: Row(
                        children: [
                          if (userDetails['owner_id'] == null)
                            for (int i = 0; i <= userDetails['driverVehicleType']['data'].length - 1; i++)
                              MyText(
                                text: '${userDetails['driverVehicleType']['data'][i]['vehicletype_name']},',
                                size: media.width * fourteen,
                                color: whiteText,
                              ),
                          if (userDetails['owner_id'] != null)
