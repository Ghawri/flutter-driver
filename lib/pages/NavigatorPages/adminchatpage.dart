            ...
            body: ValueListenableBuilder(
                ...
                builder: (context, value, child) {
                  ...
                  return Directionality(
                    textDirection: (languageDirection == 'rtl') ? ui.TextDirection.rtl : ui.TextDirection.ltr,
                    child: Stack(
                      children: [
                        Container(
                                      ...
                                      .map((i, value) {
                                        return MapEntry(
                                            ...
                                            Container(
                                              ...
                                              width: media.width * 0.9,
                                              alignment: (adminChatList[i]['from_id'].toString() ==
                                                      userDetails['user_id'].toString())
                                                  ? Alignment.centerRight
                                                  : Alignment.centerLeft,
                                              child: Column(
                                                crossAxisAlignment: (adminChatList[i]['from_id'].toString() ==
                                                        userDetails['user_id'].toString())
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          borderRadius: BorderRadius.only(
                                                            topLeft: (adminChatList[i]['from_id'].toString() ==
                                                                    userDetails['user_id'].toString())
                                                                ? Radius.circular(media.width * 0.02)
                                                                : const Radius.circular(0),
                                                            topRight: (adminChatList[i]['from_id'].toString() ==
                                                                    userDetails['user_id'].toString())
                                                                ? const Radius.circular(0)
                                                                : Radius.circular(media.width * 0.02),
                                                          ...
                                                          color: (adminChatList[i]['from_id'].toString() ==
                                                                  userDetails['user_id'].toString())
                                                              ? buttonColor
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: TextField(
                                        ...
                                        onChanged: (val) {
                                          setState(() {
                                            adminChatmessage = adminchatText.text;
                                          });
                                        },
                                      ),
                                    ),
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          boxShadow: [
                                            BoxShadow(
                                                blurRadius: 2, color: Colors.black.withOpacity(0.2), spreadRadius: 2)
                                          ],
                                          color: page,
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            child: Row(
                                              children: [
                                                Expanded(
                                                    flex: 20, child: Icon(Icons.vpn_lock_rounded, color: textColor)),
                                                Expanded(
                                                    flex: 80,
                                                    child: Text(
