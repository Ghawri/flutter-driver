...
class _UploadDocumentState extends State<UploadDocument> {
  ...
  getDocument() async {
    token = pref.getString('Bearer');
    getDocumentsNeeded(token);
    print("token $token");
  }

  getDocumentsNeeded(token) async {
    dynamic result;
    try {
                                            ...
                                            .map((k, value) => MapEntry(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          color: whiteText,
                                                          border: Border.all(
                                                              color: (isDarkTheme == false) ? Colors.white : textColor,
                                                              width: 1),
                                                        ),
                                                        child: Row(
                                                          mainAxisAlignment:
                                                              (documentsNeeded[k]['is_uploaded'] == false)
                                                                  ? MainAxisAlignment.center
                                                                  : MainAxisAlignment.spaceBetween,
                                                          children: [
                                                            (documentsNeeded[k]['is_uploaded'] == true)
                                                                ? Container(
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                      image: DecorationImage(
                                                                          image: NetworkImage(
                                                                            documentsNeeded[k]['driver_document']
                                                                                    ['data']['document']
                                                                                .toString(),
                                                                          ),
                                                                          fit: BoxFit.cover),
                                                    ...
                                                    if (documentsNeeded[k]['driver_document'] != null)
                                                      if (documentsNeeded[k]['driver_document']['data']['comment'] !=
                                                          null)
                                                        Container(
                                                          padding: EdgeInsets.only(top: media.width * 0.02),
                                                          width: media.width * 0.9,
                                                          child: MyText(
                                                            text: documentsNeeded[k]['driver_document']['data']
                                                                    ['comment']
                                                                .toString(),
                                                            size: media.width * fourteen,
                                                            textAlign: TextAlign.center,
                                        ...
                                        Stack(
                                          children: [
                                            Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.circular(12),
                                                  border: Border.all(color: whiteText, width: 1),
                                                  // color: Colors.transparent.withOpacity(0.2),
                                                ),
                      ...
                      Button(
                          ...
                          onTap: () async {
                            ...
                            if (imageFile != null) {
                              ...
                              else if (documentsNeeded[choosenDocs]['has_identify_number'] == true &&
                                  docIdNumber != '' &&
                              ...
                              else if (documentsNeeded[choosenDocs]['has_identify_number'] == false &&
                                  documentsNeeded[choosenDocs]['has_expiry_date'] == true &&
                                  date != '') {
                                var result = await uploadDocs();
