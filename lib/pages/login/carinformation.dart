            ...
            children: [
              Container(
                decoration: const BoxDecoration(
                    image: DecorationImage(image: AssetImage('assets/images/carinfo.jpg'), fit: BoxFit.cover)),
              ),
                          ...
                          ClipRRect(
                            ...
                            child: BackdropFilter(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(color: Colors.white, width: 0.5),
                                    borderRadius: BorderRadius.circular((media.width * 0.11) / 2),
                                    color: Colors.black.withOpacity(0.17)),
                            ...
                            child: Column(
                              children: [
                                if (isowner == false)
                                  Column(
                                    children: [
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            SizedBox(
                                                ...
                                                child: MyText(
                                                  text: languages[choosenLanguage]['text_register_for'],
                                                  ...
                                                  children: [
                                                    Container(
                                                      margin: EdgeInsets.only(
                                                          top: media.width * 0.025, right: media.width * 0.01),
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            Container(
                                                              ...
                                                              width: media.width * 0.05,
                                                              decoration: BoxDecoration(
                                                                  border: Border.all(color: whiteText, width: 1.2)),
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                              width: media.width * 0.15,
                                                              child: MyText(
                                                                text: languages[choosenLanguage]['text_both'],
                                                                size: media.width * fourteen,
                                                                fontweight: FontWeight.w600,
                                                                color: whiteText,
                                                              ),
                                      ...
                                      InkWell(
                                        onTap: () async {
                                          if (transportType != '' || enabledModule != 'both') {
                                        ...
                                        child: Container(
                                          ...
                                          width: media.width * 0.8,
                                          decoration: BoxDecoration(
                                            color: (transportType != '' || enabledModule != 'both')
                                                ? Colors.transparent
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child: MyText(
                                                    text: (widget.frompage == 1 && myServiceId == '')
                                                    ...
                                                    size: media.width * fourteen,
                                                    color: (widget.frompage == 1 && myServiceId == '')
                                                        ? whiteText
                                                        : whiteText),
                                              ),
                                              Icon(
                                                (transportType != '' || enabledModule != 'both')
                                ...
                                InkWell(
                                  onTap: () async {
                                    if (myServiceId != '') {
                                      vehicleConfirmed = false;
                                      choosevehicletypelistlocal.clear();
                                      for (var element in choosevehicletypelist) {
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          alignment: Alignment.center,
                                                                          child: (choosevehicletypelistlocal
                                                                                  .contains(vehicleType[k]))
                                                                              ? Container(
                                                                                  width: media.width * 0.025,
                                                                                  height: media.width * 0.025,
                                                                                  decoration: BoxDecoration(
                                      ...
                                      if (vehicleConfirmed == true && choosevehicletypelistlocal.isNotEmpty) {
                                        setState(() {
                                          _error = '';
                                        });
                                        choosevehicletypelist.clear();
                                        for (var element in choosevehicletypelistlocal) {
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                                    ...
                                                    children: choosevehicletypelist
                                                        ...
                                                        .map((k, value) => MapEntry(
                                                            ...
                                                            Container(
                                                              ...
                                                              alignment: Alignment.center,
                                                              child: MyText(
                                                                text: choosevehicletypelist[k]['name'],
                                                                size: media.width * fourteen,
                                                                color: whiteText,
                                                              ),
                                                            )))
                                        ...
                                        //  if(myServiceId == '')
                                        Icon(
                                          (myServiceId == '') ? Icons.lock_outline_rounded : Icons.keyboard_arrow_down,
                                          size: media.width * 0.05,
                                          color: whiteText,
                                        )
                                      ],
                                ...
                                Container(
                                  ...
                                  width: media.width * 0.9,
                                  decoration: BoxDecoration(
                                    color: (choosevehicletypelistlocal.isNotEmpty && vehicleConfirmed == true)
                                        ? Colors.transparent
                                        : const Color(0xFFD9D9D9).withOpacity(0.31),
                                    // color:(myServiceId != '') ? page : Color(0xFFE8EAE9),
                                    borderRadius: BorderRadius.circular(media.width * 0.01),
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: InputField(
                                            ...
                                            readonly: (choosevehicletypelistlocal.isEmpty && vehicleConfirmed == false)
                                                ? true
                                                : false,
                                            text: languages[choosenLanguage]['text_vehicle_make'],
                                      ...
                                      if (choosevehicletypelistlocal.isEmpty && vehicleConfirmed == false)
                                        Icon(
                                          Icons.lock_outline_rounded,
                                          size: media.width * 0.05,
                                          color: whiteText,
                                ...
                                Container(
                                  ...
                                  width: media.width * 0.9,
                                  decoration: BoxDecoration(
                                    color: (custommakecontroller.text.isNotEmpty)
                                        ? Colors.transparent
                                        : const Color(0xFFD9D9D9).withOpacity(0.31),
                                    // color:(myServiceId != '') ? page : Color(0xFFE8EAE9),
                                    borderRadius: BorderRadius.circular(media.width * 0.01),
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: InputField(
                                            ...
                                            readonly: (custommakecontroller.text.isEmpty ? true : false),
                                            text: languages[choosenLanguage]['text_vehicle_model'],
                                ...
                                Container(
                                  ...
                                  width: media.width * 0.9,
                                  decoration: BoxDecoration(
                                    color: (custommodelcontroller.text.isNotEmpty)
                                        ? Colors.transparent
                                        : const Color(0xFFD9D9D9).withOpacity(0.31),
                                    // color:(myServiceId != '') ? page : Color(0xFFE8EAE9),
                                    borderRadius: BorderRadius.circular(media.width * 0.01),
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: InputField(
                                            ...
                                            maxLength: 4,
                                            readonly: (custommodelcontroller.text.isEmpty) ? true : false,
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: InputField(
                                            ...
                                            readonly: numbercontroller.text.isEmpty,
                          ...
                          if (widget.frompage == 1 && userDetails.isNotEmpty && isowner != true) {
                            ...
                            if (referralcontroller.text.isNotEmpty) {
                              ...
                              for (Map<String, dynamic> json in choosevehicletypelist) {
                                ...
                                debugPrint("vehicletypelist====== $json");
                              }
                              // var reg = await updateVehicle();
                              // debugPrint("reg------ ${reg}");
                              carInformationCompleted = true;
                              // setState(() {
                              //   _isLoading = false;
