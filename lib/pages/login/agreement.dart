...
class _AggreementPageState extends State<AggreementPage> {
  ...
  navigate() async {
    ...
    if (userDetails['approve'] == true) {
      ...
      debugPrint("geetUser==== $userDetails");
      Navigator.push(context, MaterialPageRoute(builder: (context) => const RequiredInformation()));
    }
  }
  ...
  Future init()async{
    ...
    setState(() {});
    debugPrint("userDetails11=== $userDetails");
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage('assets/images/privacyagreement.png'), fit: BoxFit.contain)),
                    ),
                    SizedBox(
                    ...
                    SizedBox(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(text: languages[choosenLanguage]['text_agree_text1']),
                              TextSpan(
                              ...
                              TextSpan(text: languages[choosenLanguage]['text_agree_text2']),
                              TextSpan(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText(text: languages[choosenLanguage]['text_iagree'], size: media.width * sixteen),
                          SizedBox(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(border: Border.all(color: buttonColor, width: 2)),
                              child: ischeck == false
                                  ? null
                                  : Icon(
                                      Icons.done,
